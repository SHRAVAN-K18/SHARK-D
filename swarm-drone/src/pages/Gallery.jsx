...
/*
  IMAGE SPECS — Gallery Page
  ─────────────────────────────────────────────────────
  All images: JPEG optimised < 300 KB, dark aesthetic

  cad-render.jpg      900 × 900 px  — Full drone CAD / exploded-view render
  swarm-sim.jpg       900 × 500 px  — Top-down swarm simulation, geometric pattern
  flight-test.jpg     900 × 500 px  — Drone in flight, motion blur, dusk bg
  mission-plan.jpg    900 × 500 px  — GCS monitor, map + telemetry + waypoints
  ground-station.jpg  900 × 500 px  — Portable command unit, field environment
  electronics.jpg     900 × 500 px  — Close-up of flight controller / PCB
  team.jpg           1800 × 700 px  — Team in workshop / lab with drone hardware
  prototype.jpg       900 × 500 px  — Physical prototype airframe
  ─────────────────────────────────────────────────────
*/
      ...
      <div className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-3">
            ...
            >
              {/* swap for <img src="/gallery/cad-render.jpg" alt="Airframe Design" className="w-full h-full object-cover" /> */}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.4 }}
            className="mt-3 relative bg-slate-900 border border-slate-800 h-[220px] group overflow-hidden cursor-pointer"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-slate-800 to-slate-900 group-hover:from-slate-700 transition-colors duration-300" />
            <span className="absolute inset-0 flex items-center justify-center text-slate-600 text-sm font-mono">
              Team / workshop photo · wide · 1800 × 700 px
            </span>
            <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-black/70 to-transparent translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
              ...
              <p className="text-slate-400 text-xs mt-0.5">
                Building the future of autonomous flight · Bengaluru, India
              </p>
            </div>
          </motion.div>
